...
class ExpedientesSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        // Obtener funcionarios para asignar
        $funcionarios = User::whereHas('roles', function($query) {
            $query->whereIn('name', ['funcionario', 'funcionario_junior', 'supervisor', 'jefe_gerencia']);
        })->get();
        ...
        $expedientes = [
            [
                ...
                'gerencia_id' => $gerencias->where('codigo', 'SGLA')->first()->id ?? 1,
            ...
            [
                ...
                'gerencia_id' => $gerencias->where('codigo', 'SGDU')->first()->id ?? 2,
                'usuario_registro_id' => $funcionarios->where('gerencia_id', $gerencias->where('codigo', 'SGDU')->first()->id)->first()->id ?? 1,
            ...
            [
                ...
                'gerencia_id' => $gerencias->where('codigo', 'SGSC')->first()->id ?? 3,
            ...
            [
                ...
                'gerencia_id' => $gerencias->where('codigo', 'SGSP')->first()->id ?? 4,
                'usuario_registro_id' => $funcionarios->where('gerencia_id', $gerencias->where('codigo', 'SGSP')->first()->id)->first()->id ?? 1,
            ...
            [
                ...
                'gerencia_id' => $gerencias->where('codigo', 'SGT')->first()->id ?? 5,
