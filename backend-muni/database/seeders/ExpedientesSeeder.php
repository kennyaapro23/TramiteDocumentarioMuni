    ...
    public function run(): void
    {
        ...
        $expedientes = [
            ...
            [
                ...
                'usuario_registro_id' => $funcionarios->where('gerencia_id', $gerencias->where('codigo', 'GDUR')->first()->id)->first()->id ?? 1,
            ...
            [
                ...
                'usuario_registro_id' => $funcionarios->where('gerencia_id', $gerencias->where('codigo', 'GSPMA')->first()->id)->first()->id ?? 1,
