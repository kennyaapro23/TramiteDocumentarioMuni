...
<div class="min-h-screen bg-gray-50 py-8" x-data="tramiteFlowForm()">
    <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <form method="POST" action="{{ route('workflows.store') }}" class="space-y-8">
            ...
            <div class="bg-white shadow rounded-lg p-6" x-show="selectedTipoTramite">
                <h2 class="text-xl font-semibold mb-6">Seleccionar gerencias</h2>
                ...
                <div class="space-y-4">
                    <template x-for="gerencia in gerenciasPrincipales" :key="gerencia.id">
