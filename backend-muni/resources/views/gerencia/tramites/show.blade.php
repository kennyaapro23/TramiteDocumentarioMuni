                ...
                <div class="p-6">
                    <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                        ...
                        <button 
                            ...
                            class="flex flex-col items-center justify-center p-4 bg-green-50 hover:bg-green-100 border-2 border-green-200 hover:border-green-400 rounded-lg transition group">
                            ...
                            <span class="text-sm font-semibold text-green-700">Aprobar</span>
                        </button>
                        @endif
                        ...
                        <button 
                            ...
                            class="flex flex-col items-center justify-center p-4 bg-red-50 hover:bg-red-100 border-2 border-red-200 hover:border-red-400 rounded-lg transition group">
                            <div class="w-12 h-12 bg-red-500 rounded-full flex items-center justify-center mb-2 group-hover:scale-110 transition">
                                <i class="fas fa-times text-white text-xl"></i>
                            </div>
                            <span class="text-sm font-semibold text-red-700">Rechazar</span>
                        </button>
                        @endif
                        ...
                        <button 
                            ...
                            class="flex flex-col items-center justify-center p-4 bg-blue-50 hover:bg-blue-100 border-2 border-blue-200 hover:border-blue-400 rounded-lg transition group">
                            ...
                            <span class="text-sm font-semibold text-blue-700">Asignar</span>
                        </button>

                        <!-- Agregar Observación -->
                        <button 
                            onclick="agregarObservacion()"
                            class="flex flex-col items-center justify-center p-4 bg-yellow-50 hover:bg-yellow-100 border-2 border-yellow-200 hover:border-yellow-400 rounded-lg transition group">
                            ...
                            <span class="text-sm font-semibold text-yellow-700">Observación</span>
                        </button>

                        <!-- Adjuntar Documento -->
                        <button 
                            onclick="adjuntarDocumento()"
                            class="flex flex-col items-center justify-center p-4 bg-indigo-50 hover:bg-indigo-100 border-2 border-indigo-200 hover:border-indigo-400 rounded-lg transition group">
                            <div class="w-12 h-12 bg-indigo-500 rounded-full flex items-center justify-center mb-2 group-hover:scale-110 transition">
                                <i class="fas fa-paperclip text-white text-xl"></i>
                            </div>
                            <span class="text-sm font-semibold text-indigo-700">Adjuntar</span>
                        </button>

                        <!-- Solicitar Información -->
                        <button 
                            onclick="solicitarInformacion()"
                            class="flex flex-col items-center justify-center p-4 bg-orange-50 hover:bg-orange-100 border-2 border-orange-200 hover:border-orange-400 rounded-lg transition group">
                            <div class="w-12 h-12 bg-orange-500 rounded-full flex items-center justify-center mb-2 group-hover:scale-110 transition">
                                <i class="fas fa-question-circle text-white text-xl"></i>
                            </div>
                            <span class="text-sm font-semibold text-orange-700">Solicitar Info</span>
                        </button>

                        <!-- Derivar -->
                        <button 
                            onclick="derivarTramite()"
                            class="flex flex-col items-center justify-center p-4 bg-purple-50 hover:bg-purple-100 border-2 border-purple-200 hover:border-purple-400 rounded-lg transition group">
                            <div class="w-12 h-12 bg-purple-500 rounded-full flex items-center justify-center mb-2 group-hover:scale-110 transition">
                                <i class="fas fa-share text-white text-xl"></i>
                            </div>
                            <span class="text-sm font-semibold text-purple-700">Derivar</span>
                        </button>

                        <!-- Imprimir -->
                        <button 
                            onclick="window.print()"
                            class="flex flex-col items-center justify-center p-4 bg-gray-50 hover:bg-gray-100 border-2 border-gray-200 hover:border-gray-400 rounded-lg transition group">
                            <div class="w-12 h-12 bg-gray-500 rounded-full flex items-center justify-center mb-2 group-hover:scale-110 transition">
                                <i class="fas fa-print text-white text-xl"></i>
                            </div>
                            <span class="text-sm font-semibold text-gray-700">Imprimir</span>
                        </button>
                    </div>
                </div>
            </div>
...
<div id="modalAvanzar" class="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full hidden z-50">
...
<script>
    ...
    function aprobarTramite() {
        if (confirm('¿Está seguro de APROBAR este trámite?\n\nEsta acción cambiará el estado del trámite a "Aprobado".')) {
            // TODO: Implementar lógica de aprobación
            alert('Funcionalidad en desarrollo: Aprobar Trámite');
            // window.location.href = '/gerencia/tramites/{{ $expediente->id }}/aprobar';
        }
    }

    function rechazarTramite() {
        const motivo = prompt('¿Por qué desea RECHAZAR este trámite?\n\nIngrese el motivo del rechazo:');
        if (motivo && motivo.trim()) {
            if (confirm('¿Está seguro de RECHAZAR este trámite?')) {
                // TODO: Implementar lógica de rechazo
                alert('Funcionalidad en desarrollo: Rechazar Trámite\nMotivo: ' + motivo);
                // window.location.href = '/gerencia/tramites/{{ $expediente->id }}/rechazar?motivo=' + encodeURIComponent(motivo);
            }
        }
    }

    function asignarUsuario() {
        alert('Funcionalidad en desarrollo: Asignar Usuario\n\nPermitirá asignar este trámite a un funcionario específico de la gerencia.');
        // TODO: Abrir modal con lista de usuarios disponibles
    }

    function agregarObservacion() {
        const observacion = prompt('Ingrese su observación sobre este trámite:');
        if (observacion && observacion.trim()) {
            // TODO: Implementar guardado de observación
            alert('Funcionalidad en desarrollo: Agregar Observación\nObservación: ' + observacion);
            // Enviar AJAX para guardar observación
        }
    }

    function adjuntarDocumento() {
        alert('Funcionalidad en desarrollo: Adjuntar Documento\n\nPermitirá subir documentos adicionales al trámite.');
        // TODO: Abrir modal con formulario de carga de archivos
    }

    function solicitarInformacion() {
        const solicitud = prompt('¿Qué información adicional necesita?\n\nIngrese su solicitud:');
        if (solicitud && solicitud.trim()) {
            alert('Funcionalidad en desarrollo: Solicitar Información\nSolicitud: ' + solicitud);
            // TODO: Enviar notificación al ciudadano
        }
    }

    function derivarTramite() {
        alert('Funcionalidad en desarrollo: Derivar Trámite\n\nPermitirá derivar este trámite a otra gerencia o área.');
        // TODO: Abrir modal con selector de gerencias/áreas
    }
</script>
@endsection
