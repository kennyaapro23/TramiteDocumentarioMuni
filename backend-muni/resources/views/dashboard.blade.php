                    ...
                    <div class="mt-2 flex flex-wrap gap-2">
                        ...
                        @role('funcionario')
                            <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-yellow-100 text-yellow-800">
                                <i class="fas fa-user-tie mr-1"></i> Funcionario
                            </span>
                        @endrole
                        
                        @role('funcionario_junior')
                            <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-orange-100 text-orange-800">
                                <i class="fas fa-user mr-1"></i> Funcionario Junior
                            </span>
                        @endrole
                    ...
                    <div class="px-4 py-5 sm:p-6">
                        ...
                        <div class="mt-8">
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                ...
                                @role('funcionario|funcionario_junior')
                                    <div class="bg-blue-50 p-4 rounded-lg">
                                        <div class="flex items-center">
                                            <div class="flex-shrink-0">
                                                <svg class="h-8 w-8 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                                ...
                                @role('superadministrador|administrador')
                                    ...
                                    @can('ver_reportes_sistema')
                                        <a href="#" class="bg-red-600 hover:bg-red-700 text-white px-4 py-3 rounded-md text-sm font-medium transition duration-150 ease-in-out flex items-center justify-center">
                                            <svg class="h-5 w-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                @role('jefe_gerencia')
                                    ...
                                    <a href="#" class="bg-orange-600 hover:bg-orange-700 text-white px-4 py-3 rounded-md text-sm font-medium transition duration-150 ease-in-out flex items-center justify-center">
                                        <svg class="h-5 w-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 17v-2m3 2v-4m3 4v-6m2 10H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path>
                                        </svg>
                                        Reportes Gerencia
